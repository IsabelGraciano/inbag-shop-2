...
<section class="page-section customer" id="customer">
    <div class="container">
        <div class="row justify-content-center space-column">
            <div class="col-md-8">
                <div class="card">
                            ...
                            <div class="center">
                                <div class="form-group row mb-0">
                                    <div class="col-md-8 offset-md-4">
                                        ...
                                        <a class="btn btn-primary" href="{{ url('/auth/redirect/google') }}">{{ __('auth.login_google') }}</a>
                                        <hr>                                        
                                        @if (Route::has('password.request'))

                                        <a class="btn btn-link" href="{{ route('register', app()->getLocale()) }}">
                                            {{ __('master.admin.registerLogin') }}
                                        </a>
