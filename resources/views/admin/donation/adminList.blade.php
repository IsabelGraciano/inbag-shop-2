...
<section class="page-section donation" id="donation">
    <div class="container">
        ...
        <h2 class="page-section-heading text-center text-uppercase text-secondary mb-5">{{__('donation.adminlist.title')}}</h2>
        <!-- Icon Divider-->
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4 pb-5 mb-lg-0">
                <div class="portfolio-item mx-auto" data-toggle="modal">
                    <a href="{{ route('admin.donation.adminView', $donation->getId() ) }}">
